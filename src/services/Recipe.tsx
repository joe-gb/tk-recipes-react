...
const RecipeService: Function = () => {
    ...
    const GetRecipes: Function = (search: string): [Array<Recipe>, boolean, AxiosError | null] => {
    ...
    const GetRecipe: Function = (id: Number, manual: boolean): [Recipe | undefined, boolean, AxiosError | null, Function] => {
    ...
    const SaveRecipe: Function = (): [Recipe | undefined, boolean, AxiosError | null, Function] => {
    ...
    const DeleteRecipe: Function = (id: number): [boolean, boolean, AxiosError | null, Function] => {
