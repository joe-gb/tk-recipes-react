...
function RecipeDelete() {
    ...
    let [deletedRecipe, deleteLoading, deleteError, triggerDelete] = RecipeService.DeleteRecipe(id)
    ...
    if (deletedRecipe) {
        return (
            <Card>
                ...
                <Successbox><h3>Success</h3><p>Recipe '{recipe.name}' deleted</p></Successbox>
                <Link to={'/recipes'}><Button>See more recipes</Button></Link>
            </Card>
        )
    }
